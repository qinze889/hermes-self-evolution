...
> 📦 **GitHub 热榜** | ⭐ 10/10 | https://github.com/fjwood69/mori

## 这是什么
Mori MCP server — A shared memory layer for AI coding agents — one that compounds.

## 为什么对 Hermes 重要
- 📦 **fjwood69/mori**: Mori MCP server — A shared memory layer for AI coding agents — one that compounds.
- 🔧 MCP 工具链：评估该实现是否可注册为 Hermes 原生工具

## 建议行动
- **分析 [fjwood69/mori](https://github.com/fjwood69/mori) 的 MCP 实现，评估注册为 Hermes 工具的可行性与工作量**
  - 📈 收益: 扩展 Hermes 工具链能力  ⏱ 工作量: 中  🏷️ tool
- **阅读 [fjwood69/mori](https://github.com/fjwood69/mori) 的 agent 架构设计，提取可复用模式**
