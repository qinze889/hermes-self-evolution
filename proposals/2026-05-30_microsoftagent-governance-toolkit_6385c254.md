...
> 📦 **GitHub 热榜** | ⭐ 11/10 | https://github.com/microsoft/agent-governance-toolkit
...
## 建议行动
- **阅读 [microsoft/agent-governance-toolkit](https://github.com/microsoft/agent-governance-toolkit) 的 agent 架构设计，提取可复用模式**
