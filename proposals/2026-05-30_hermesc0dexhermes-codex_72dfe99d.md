...
source_url: https://github.com/hermesc0dex/hermes-codex
score: 7
category: GitHub 热榜
approved_at: ~
implemented_at: ~
...
# 📋 hermesc0dex/hermes-codex

> 📦 **GitHub 热榜** | ⭐ 7/10 | https://github.com/hermesc0dex/hermes-codex
...
## 建议行动
- **阅读 [hermesc0dex/hermes-codex](https://github.com/hermesc0dex/hermes-codex) 的 agent 架构设计，提取可复用模式**
