...
source_url: https://github.com/qadeer-ux/oh-my-codex-remix
score: 11
category: GitHub 热榜
approved_at: ~
implemented_at: ~
...
# 📋 qadeer-ux/oh-my-codex-remix

> 📦 **GitHub 热榜** | ⭐ 11/10 | https://github.com/qadeer-ux/oh-my-codex-remix
...
## 建议行动
- **阅读 [qadeer-ux/oh-my-codex-remix](https://github.com/qadeer-ux/oh-my-codex-remix) 的 agent 架构设计，提取可复用模式**
