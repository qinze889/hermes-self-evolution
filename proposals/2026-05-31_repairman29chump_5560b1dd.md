...
> 📦 **GitHub 热榜** | ⭐ 8/10 | https://github.com/repairman29/chump

## 这是什么
Self-hosted AI coding agent with persistent memory and bounded autonomy. Local-first, your keys, your data. Written in Rust.

## 为什么对 Hermes 重要
- 📰 值得关注的行业动态

## 建议行动
- **阅读 [repairman29/chump](https://github.com/repairman29/chump) 的 agent 架构设计，提取可复用模式**
