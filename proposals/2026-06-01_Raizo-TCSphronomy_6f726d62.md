...
source_url: https://github.com/Raizo-TCS/phronomy
score: 7
category: GitHub 热榜
approved_at: ~
implemented_at: ~
...
> 📦 **GitHub 热榜** | ⭐ 7/10 | https://github.com/Raizo-TCS/phronomy

## 这是什么
Ruby AI Agent Framework — Workflows, Agents, Tools, Guardrails, and Tracing — powered by RubyLLM

## 为什么对 Hermes 重要
- 📦 **Raizo-TCS/phronomy**: Ruby AI Agent Framework — Workflows, Agents, Tools, Guardrails, and Tracing — powered by RubyLLM
- 🤖 Agent 设计：该项目的架构思路可参考用于改进 Hermes agent 层

## 建议行动
- **阅读 [Raizo-TCS/phronomy](https://github.com/Raizo-TCS/phronomy) 的 agent 架构设计，提取可复用模式**
