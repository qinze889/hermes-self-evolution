...
source_url: https://github.com/Carlos-Projects/mcp-attest
score: 10
category: GitHub 热榜
approved_at: ~
implemented_at: ~
...
> 📦 **GitHub 热榜** | ⭐ 10/10 | https://github.com/Carlos-Projects/mcp-attest

## 这是什么
🔐 Attested Tool-Server Admission for MCP — verify identity, integrity, and trust of MCP servers before connecting

## 为什么对 Hermes 重要
- 📰 值得关注的行业动态

## 建议行动
- **分析 [Carlos-Projects/mcp-attest](https://github.com/Carlos-Projects/mcp-attest) 的 MCP 实现，评估注册为 Hermes 工具的可行性与工作量**
